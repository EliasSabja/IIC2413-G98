...
def get_text_search():
    ...
    if deseables and not requeridas and not prohibidas and not hay_id:
        return json.jsonify({"message": "No especificaste palabras requeridas ni prohibidas ni tampoco un id", "success": False})
